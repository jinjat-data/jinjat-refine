...
import {
    ...
    ChevronRight,
    MenuRounded,
    Dashboard, LightModeOutlined, DarkModeOutlined,
} from "@mui/icons-material";
import {ColorModeContext} from "./header";
import {useSchemaProvider} from "../hooks/useSchemaProvider";

export const TitleWithLogo: React.FC<TitleProps> = ({ collapsed }) => {
...
export const JinjatSider: React.FC<RefineLayoutSiderProps> = ({ render }) => {
    ...
    const RenderToTitle = Title ?? TitleWithLogo;
